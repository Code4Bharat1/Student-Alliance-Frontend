    ...
    const fetchProducts = async () => {
      ...
      try {
        const res = await axios.get(
          "http://localhost:5000/api/products/category/Digital%20Board "
        );
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="bg-white text-black mt-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h1 className="text-4xl mb-15 ml-64 font-bold">Digital Board</h1>
            </motion.div>

            {/* Product Cards */}
            <div className="grid grid-cols-1  ml-64 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6 pb-16">
